...
modelo_sin_limite = gp.read("datos_modelo/modelo_sl.lp")
with open("datos_modelo/valores_sl.json", "r") as f:
...
count_centros_fijados, centros_frac, top_centros_frac = extraer_prob_centros(
    modelo_sin_limite, K_centros, valores
)
centros_fijados = extraer_centros_fijados(modelo_sin_limite, valores)
